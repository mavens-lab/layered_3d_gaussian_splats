...
class Scene:
    ...
    def __init__(
        ...
        elif os.path.exists(os.path.join(args.source_path, "trace.txt")):
            print("Found trace.txt file, assuming VR viewer data set!")
            scene_info = sceneLoadTypeCallbacks["VrViewer"](
                args.source_path, args.white_background, args.eval
            )
        else:
