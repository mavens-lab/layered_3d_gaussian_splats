      ...
      while true; do
        ...
        if [[ -n $gpu_id ]]; then
          ...
          CUDA_VISIBLE_DEVICES=$gpu_id python prune_finetune_sorting_single.py \
            ...
            -m "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/sort/${arg}_${prune_type}_ply_sort_all_from1m" \
            --eval \
            --port $port \
            ...
            --v_pow $vp > "logs_sort/${arg}_${prune_type}_ply_sort_all_from1m .log" 2>&1
