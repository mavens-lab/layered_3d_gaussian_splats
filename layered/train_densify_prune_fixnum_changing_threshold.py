...
def training(
    ...
    opt.iterations = 300_000
    opt.densify_until_iter = 60_000
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        default=[500,10_000,20_000,40_000,50_000,80_000,100_000,120_000,140_000,150_000,170_000,200_000,300_000],
    )
    parser.add_argument(
        "--save_iterations", nargs="+", type=int, default=[500,10_000,20_000,40_000,50_000,80_000,100_000,120_000,140_000,150_000,170_000,200_000,300_000]
    )
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument(
        "--checkpoint_iterations", nargs="+", type=int, default=[500,10_000,20_000,40_000,50_000,80_000,100_000,120_000,140_000,150_000,170_000,200_000,300_000]
    )
