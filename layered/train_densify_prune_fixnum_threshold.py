...
def training(
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                if scene.gaussians.get_xyz.shape[0] > args.max_splat_num and iteration%400 == 0: 
                    # TODO Add prunning types
                    gaussian_list, imp_list = prune_list(gaussians, scene, pipe, background)
                    # i = args.prune_iterations.index(iteration)
                    v_list = calculate_v_imp_score(gaussians, imp_list, args.v_pow)
                    ...
                    #     args.max_splat_num, v_list
                    # )
                    if 1-(args.max_splat_num/scene.gaussians.get_xyz.shape[0])>0.3:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        default=[500,7_000, 10_000,15_000,20_000,30_000,40_000,44_000,46_000,48_000,49_000,50_000,80_000,100_000],
    )
    parser.add_argument(
        "--save_iterations", nargs="+", type=int, default=[500,7_000, 10_000,15_000,20_000,30_000,40_000,44_000,46_000,48_000,49_000,50_000,80_000,100_000]
    )
    parser.add_argument("--quiet", action="store_true")
    parser.add_argument(
        "--checkpoint_iterations", nargs="+", type=int, default=[500,7_000, 10_000,15_000,20_000,30_000,40_000,44_000,46_000,48_000,49_000,50_000,80_000,100_000]
    )
    ...
    parser.add_argument(
        "--max_splat_num", type=int, default=18_000
    )
