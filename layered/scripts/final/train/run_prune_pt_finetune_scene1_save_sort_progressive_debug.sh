...
for arg in "${run_args[@]}"; do
  ...
  python prune_finetune_sorting_progressive.py \
    ...
    --eval \
    --port $port \
    --start_pointcloud_sort "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/sort/${arg}_v_important_score_ply_sort_all_from180/point_cloud/iteration_3/point_cloud.ply" \
    --load_pointcloud_sort "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/${arg}_45000/point_cloud/iteration_5000/point_cloud.ply" \
    --iteration 5000 \
    --prune_iterations 2 \
