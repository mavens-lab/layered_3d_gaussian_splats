        ...
        with torch.no_grad():
            ...
            if iteration in args.prune_iterations:
                ...
                if args.prune_type == "important_score":
                    gaussians.sort_gaussians(imp_list)
                elif args.prune_type == "v_important_score":
                    # normalize scale
                    v_list = calculate_v_imp_score(gaussians, imp_list, args.v_pow)
                    gaussians.sort_gaussians(v_list)
                    ...
                    gaussians.sort_gaussians(gaussian_list)
                elif args.prune_type == "opacity":
                    gaussians.sort_gaussians(gaussians.get_opacity.detach())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_num", type=float, default=6_000)
