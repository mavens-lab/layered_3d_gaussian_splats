...
declare -a target_num_save=(90000)
declare -a target_num_train=(135000)
      ...
      while true; do
        ...
        if [[ -n $gpu_id ]]; then
          ...
          CUDA_VISIBLE_DEVICES=$gpu_id python prune_finetune_sorting_progressive.py \
            ...
            --load_pointcloud_sort "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/train_45000_90000_v_important_score_sort_progressive/point_cloud/iteration_5000/point_cloud.ply" \
            --iteration 5000 \
