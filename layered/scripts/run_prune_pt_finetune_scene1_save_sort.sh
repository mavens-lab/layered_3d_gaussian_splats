      ...
      while true; do
        ...
        if [[ -n $gpu_id ]]; then
          ...
          CUDA_VISIBLE_DEVICES=$gpu_id python prune_finetune_save_sort.py \
            ...
            -m "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/${arg}_${target_num}_${prune_type}_sort_from180" \
            --eval \
            --port $port \
            --start_pointcloud "/scratch/jiasi_root/jiasi98/zxuechen/OUTPUT/PATH/baseline/train_180000/point_cloud/iteration_5000/point_cloud.ply" \
            --iteration 2 \
            --test_iterations 2 \
            --save_iterations 2 \
            --prune_iterations 2 \
            ...
            --v_pow $vp > "logs_prune/${arg}${target_num}_${prune_type}_ply_sort_from180 .log" 2>&1
